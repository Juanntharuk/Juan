...
public class Panel_Input extends JPanel {
    ...
    public Panel_Input() {
        ...
        cbJava.setBounds(100, 280, 80, 30);

        cbPhyton = new JCheckBox("Phyton");
        cbPhyton.setBounds(220, 280, 80, 30);

        cbKotlin = new JCheckBox("Kotlin");
        cbKotlin.setBounds(350, 280, 80, 30);

        cbpp = new JCheckBox("C++");
        cbpp.setBounds(490, 280, 80, 30);

        // Button untuk submit data
        btnSubmit = new JButton("Simpan");
        btnSubmit.setBounds(570, 80, 100, 50);

        btnBatal = new JButton("Batal");
        btnBatal.setBounds(570, 150, 100, 50);

        btnHapus = new JButton("Hapus");
        btnHapus.setBounds(570, 220, 100, 50);
        ...
        tableScrollPane.setBounds(20, 335, 640, 120);
